...
export default function BrandStartThanksPage() {
  useEffect(() => {
    if (typeof window !== "undefined" && window.gtag) {
      window.gtag("event", "conversion", {
        event_category: "lp_brand_start",
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-[#ddeaf8] p-10 max-w-md w-full text-center">
        ...
        <div className="bg-[#f8fafd] rounded-xl p-4 mb-8 text-left">
          ...
          <ul className="space-y-1.5 text-sm text-gray-600">
            ...
            <li className="flex items-start gap-2"><span className="text-[#15447b] font-bold mt-0.5">3.</span>ご要望に合わせたプランをご提案</li>
          </ul>
        </div>
        <Link
          href="/lp/brand-start"
