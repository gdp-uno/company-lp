    ...
    >
      <div className="max-w-[1280px] mx-auto px-4 sm:px-8 h-16 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-7 text-[13px] text-[#0a1f3d]/75 font-medium">
          ...
          <a href="#why" className="hover:text-[#15447b] transition-colors">選ばれる理由</a>
          <a href="#plans" className="hover:text-[#15447b] transition-colors">料金プラン</a>
          <a href="#flow" className="hover:text-[#15447b] transition-colors">ご相談の流れ</a>
