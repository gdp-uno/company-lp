...
export default function DxDiagram() {
  return (
    <div className="grid grid-cols-[1fr_44px_1fr]">
      ...
      {/* Center arrow — flex items-center centers vertically across full grid row height */}
      <div className="flex items-center justify-center">
        <div className="hidden sm:flex items-center justify-center w-10 h-10 bg-[#fbbf24] rounded-full shadow-lg ring-4 ring-white">
